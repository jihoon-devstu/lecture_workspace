            ...
            <div class="card card-primary">
              ...
              <form id = "form1">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" name="introduce" value = "<%=product.getDetail()%>">
                  </div>
					<div class="form-group">
...
<!-- ./wrapper -->
	...
	function getImgList(dir,filename){
		...
		$.ajax({
			...
			//3) 이파일을 읽어들인 후 e.target.result 형태로 img src에 대입
			//XMLHttpRequest 객체를 이용해야함
			xhr:function(){
				const xhr = new XMLHttpRequest();
				xhr.responseType="blob"; //blob 형태의 데이터 요청
				//blob이란 ?? Binary Large Object의 준말로 , 이미지 , 비디오 , 오디오 , 일반 파일 등의 이진 데이터를 
				//담을 수 있는 자바스크립트 객체
				return xhr;
			},
			success:function(result, status, xhr){
