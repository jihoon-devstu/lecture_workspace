...
<head>
  ...
  <title>AdminLTE 3 | Projects</title>
	<!-- Style include -->
  		<%@ include file="/project_inc/head_link.jsp" %>
	<!-- /Style include -->
	<!-- head_link -->
		<%@ include file="/project_inc/footer_link.jsp" %>
	<!-- head_link -->
</head>
...
<div class="wrapper">
  ...
  <!-- Navbar -->
  	<%@ include file = "/project_inc/navbar.jsp" %>
  <!-- /Navbar -->

  <!-- Main Sidebar Container -->
	<%@ include file = "/project_inc/left_bar" %>
                      ...
                      <td>
                          <ul class="list-inline">
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="/static/admin/dist/img/avatar.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="/static/admin/dist/img/avatar2.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="/static/admin/dist/img/avatar3.png">
                              </li>
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="/static/admin/dist/img/avatar4.png">
                              </li>
                          </ul>
                      </td>
                  ...
                  <tr>
                      ...
                      <td>
                          <ul class="list-inline">
                              ...
                              <li class="list-inline-item">
                                  <img alt="Avatar" class="table-avatar" src="/static/admin/dist/img/avatar5.png">
                              </li>
                          </ul>
                      </td>
                      <td class="project_progress">
