                    ...
                    <div class="product__details__pic">
                        ...
                        <%for(int i=0;i<product.getImgList().size();i++){ %>
                            <a class="pt active" href="#product-1">
                                <img src="/data/p_<%=product.getProduct_id() %>/<%=product.getImgList().get(0).getFilename() %>" alt="">
                            </a>
                            <%} %>
                        </div>
                        <div class="product__details__slider__content">
                        	...
                        	<%for(int i=0;i<product.getImgList().size();i++){ %>
                                <img data-hash="product-1" class="product__big__img" src="/data/p_<%=product.getProduct_id() %>/<%=product.getImgList().get(i).getFilename() %>" alt="">
                                <%} %>
                            </div>
                        </div>
                    </div>
